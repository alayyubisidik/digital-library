...
class DashboardAdminController extends Controller
{
    ...
    {
        $countUser = User::where('role', 'member')->count();
    ...
    public function user()
    {
        ...
        $users = User::where('role', 'member')->orWhere('role', 'officer')->withCount('borrowings')->get();
        // dd($users);
    ...
    public function bookCreate (Request $request)
    {
        ...
        if ($request->isMethod('GET')) {
            ...
            return redirect('/dashboard-admin/book');
        }
    }
    ...
    public function rating ($book_id){
        return view('dashboard-admin.book.rating', [
    ...
    public function changeAccessStatusUser(Request $request)
    {
        $user = User::where('username', $request->username)->first();
        $user->access_status = intval($request->access_status);
        $user->save();
    ...
    public function generateReport(Request $request)
    {
        ...
        if ($request->input('start_date')) {
            ...
            return view('dashboard-admin.generate-report.index', [
                "borrowings" => $borrowings
            ]);
        }
