...
@section('content')
    <div class="content-wrapper">
        <a href="/dashboard-officer/book">
            <button type="button" class="btn btn-warning mr-2 mb-3">Back</button>
        </a>
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Book</h4>
                <form class="forms-sample" action="/dashboard-officer/book/edit/{{ $book->slug }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <img id="preview" src="{{ asset('/storage/book-cover/' . $book->cover) }}" alt="Preview"
