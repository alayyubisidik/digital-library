    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Book Manajemen</h4>
                <a href="/dashboard-officer/book/create">
                    ...
                    <tbody>
                        @foreach ($books as $book)
                            <tr>
                                ...
                                <td >
                                    <a style="color: white; text-decoration: none;" href="/dashboard-officer/book/delete/{{ $book->id }}">
                                        <button class="badge badge-danger mr-3">Hapus</button>
                                    </a>
                                    <a style="color: white; text-decoration: none;"  href="/dashboard-officer/book/edit/{{ $book->slug }}">
                                        <button class="badge badge-primary ">Edit</button>
                                    </a>
                                    <a style="color: white; text-decoration: none;"  href="/dashboard-officer/book/rating/{{ $book->id }}">
